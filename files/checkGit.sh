...
REPOOUTPUT=$(curl -k -u $TL_USER:$TL_PASS \
  ...
  https://$TL_CONSOLE/api/v1/coderepos?id=joeyrogo%2Fbase-evil.petclinic&limit=15&offset=0&project=Central+Console&reverse=true&sort=vulnerabilityRiskScore)
